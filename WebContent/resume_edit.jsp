...
<body>
	...
	<div class="row">
		...
		<form action="resumesave" method="post" name="form_edit_resume"
			...
			<input name="id_res" id="id_res" type="hidden" value="<c:out value="${res9}" />" />
			<div style="padding: 20px 30px 20px 10px;" class="col-md-10">
				...
				<div class="form-inline"
					...
					Title: <input type="text" class="form-control" id="title"
						placeholder="Write a Title for the Resume" name="title"
						value="<c:out value="${res1}" />">
					<c:if test="${res6 == 1}">
						<span id="publicc"
							style="color: #009d00; padding: 5px 0px 0px 30px;"> <input
							name="public" id="public" type="checkbox" checked="checked"
							value="no" onclick="check()" /> Public?
						</span>
					</c:if>
					<c:if test="${res6 == 0}">
						<span id="publicc"
							style="color: #c60000; padding: 5px 0px 0px 30px;"> <input
							name="public" id="public" type="checkbox" value="no"
				...
				<div id="ps" style="display: none; padding-bottom: 5px;">
					<textarea id="professional_summary" name="professional_summary">${res2}</textarea>
				</div>
				<div id="ps_t" style="display: block; padding-bottom: 5px;">${res2}</div>
				...
				<div id="ts" style="display: none; padding-bottom: 5px;">
					<textarea id="technical_skills" name="technical_skills">${res3}</textarea>
				</div>
				<div id="ts_t" style="display: block; padding-bottom: 5px;">${res3}</div>
				...
				<div id="pe" style="display: none; padding-bottom: 5px;">
					<textarea id="professional_experience"
						name="professional_experience">${res4}</textarea>
				</div>
				<div id="pe_t" style="display: block; padding-bottom: 5px;">${res4}</div>
				...
				<div id="ed" style="display: none; padding-bottom: 5px;">
					<textarea id="education" name="education">${res5}</textarea>
				</div>
				<div id="ed_t" style="display: block; padding-bottom: 5px;">${res5}</div>
